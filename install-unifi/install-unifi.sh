...
UNIFI_SOFTWARE_URL="https://dl.ubnt.com/unifi/5.3.8/UniFi.unix.zip"
...
env ASSUME_ALWAYS_YES=YES /usr/sbin/pkg add ${FREEBSD_PACKAGE_URL}java-zoneinfo-2016.i.txz
...
env ASSUME_ALWAYS_YES=YES /usr/sbin/pkg add ${FREEBSD_PACKAGE_URL}libXi-1.7.8,1.txz
...
env ASSUME_ALWAYS_YES=YES /usr/sbin/pkg add ${FREEBSD_PACKAGE_URL}openjdk8-8.112.16_1.txz
...
fetch http://pkg.freebsd.org/freebsd:11:x86:${OS_ARCH}/latest/All/snappyjava-1.0.4.1_2.txz
